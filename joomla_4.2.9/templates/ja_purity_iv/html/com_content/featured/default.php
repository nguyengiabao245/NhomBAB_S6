...
<div class="blog-featured" itemscope itemtype="https://schema.org/Blog">
  <div class="view-masonry">
    ...
    <?php if ($this->params->def('show_pagination', 2) == 1  || ($this->params->get('show_pagination') == 2 && $this->pagination->pagesTotal > 1)) : ?>
      ...
      Factory::getDocument()->addScript(JUri::base() . 'templates/' . $app->getTemplate() . '/js/infinitive-paging.js');
      Factory::getDocument()->addScript(JUri::base() . 'templates/' . $app->getTemplate() . '/js/jquery.infinitescroll.js');
      $mode = 'manual';
      ...
      if ($this->pagination->pagesTotal > 1) : ?>
        ...
        <div class="infinity-wrap d-flex justify-content-center">
          <div id="infinity-next" class="btn btn-more btn-outline-dark" data-limit="<?php echo $this->pagination->limit; ?>" data-url="<?php echo JUri::current(); ?>" data-mode="<?php echo $mode ?>" data-pages="<?php echo $this->pagination->pagesTotal ?>" data-finishedmsg="<?php echo Text::_('TPL_LOADMORE_END_MSG'); ?>">
